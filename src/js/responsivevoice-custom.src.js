    ...
    var ResponsiveVoice = function () {
        ...
        if (window.navigator) {
            ...
            if (window.navigator.platform === "MacIntel") {
                ...
                // gives us microsoft Anna for windows 7
                self.responsivevoices[63].voiceIDs.unshift(256)
            } else if (window.navigator.platform === "Win32" &&
                       window.navigator.userAgent.indexOf("Chrome") === -1 &&
                       (window.navigator.userAgent.indexOf("Windows NT 6.2") > -1 || window.navigator.userAgent.indexOf("Windows NT 6.3") > -1)) {
                // gives us microsoft David for windows 8
                self.responsivevoices[63].voiceIDs.unshift(257)
            }
        }
        ...
        self.voicecollection = [
            ...
            {name: 'Microsoft Anna - English (United States)', pitch: 0.4}, //256 firefox on windows 7 and under
            {name: 'Microsoft David Desktop - English (United States)', pitch: 0.4}, //257 firefox on windows 8 and up
        ];
