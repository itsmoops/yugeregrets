        ...
        { showACLUMessage && (
          <div className="bottom__banner fade-appear">
            <span className="donate">
              Make you feel bad{'?'} You{"'"}re probably a good person. <a href="https://action.aclu.org/secure/donate-to-aclu" onClick={() => { trackOutboundLink("https://action.aclu.org/secure/donate-to-aclu"); return false; }}>Donate to the ACLU here.</a>
            </span>
          </div>
        ) }
      </div>
  ...
  render() {
    return (
      <div className="social__share">
        <div className="fb-share-button fb__share"
